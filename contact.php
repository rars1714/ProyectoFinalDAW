            ...
            <form class="col-md-9 m-auto" method="post" role="form">
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control mt-1" id="apellido" name="apellido" placeholder="Apellido">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Correo</label>
                        <input type="text" class="form-control mt-1" id="email" name="email" placeholder="Correo">
                    </div>
                    <div class="form-group col-md-6 mb-3">
